...
import { HeavyComponent } from "../../components/common/heavy-component";
...
const DynamicHeavyComponent = dynamic(
  async () => {
    ...
    return import("../../components/common/heavy-component").then((mod) => mod.HeavyComponent);
  },
  {
    loading: () => (
  ...
  return (
    <div className="container mx-auto p-8 space-y-8">
      <div className="prose dark:prose-invert">
        ...
        <p>
          This demo shows the difference between regular imports and dynamic imports. Click the
          buttons below to load the components:
        </p>
      </div>
      ...
      <div className="prose dark:prose-invert">
        ...
        <ul>
          <li>
            <strong>Regular Import:</strong> The component code is included in the main bundle and
            loaded when the page loads, even if we don't show it immediately.
          </li>
          <li>
            <strong>Dynamic Import:</strong> The component code is split into a separate chunk and
            only loaded when needed, reducing the initial bundle size.
          </li>
        </ul>
